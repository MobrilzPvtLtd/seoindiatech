    ...
    content: [
      {
        type: 'paragraph',
        text:
          'If you have used Google lately, you have likely noticed a colourful box at the very top of your search results. This is the Google AI Overview. Instead of just giving you a list of links, Google now uses artificial intelligence to read through multiple websites and summarise the answer for you in a few short paragraphs.',
      },
      {
        type: 'paragraph',
        text:
      ...
      {
        type: 'heading',
        text: 'What Google AI Overviews Mean for SEO?',
      },
      {
        type: 'paragraph',
        text:
          "In the past, SEO was a straightforward race to the 'top 10' blue links. If you were on the first page, you were successful. AI Overviews have changed that layout. Now, the AI result often sits above the traditional links, pushing them further down the page.",
      },
      {
        type: 'paragraph',
        text:
      ...
      {
        type: 'paragraph',
        text: `The biggest difference is that "ranking" now has two parts:`,
      },
      {
        type: 'list',
        items: [
          '<strong>Traditional Ranking:</strong> Your website appears in the list of links below the AI box.',
          '<strong>AI Citations:</strong> Your website is featured as a source within the AI box itself, often with a small link or card that users can click to learn more.',
        ],
      },

      {
        type: 'heading',
        text: 'The Real Effects of AI Overviews on SEO',
      },
      {
        type: 'paragraph',
        text: `It is important to be realistic about how this affects your traffic. We are moving toward what experts call "zero-click searches."`,
      },
      {
        type: 'list',
        items: [
      ...
      {
        type: 'heading',
        text: 'Common SEO Mistakes That Hurt AI Overview Visibility',
      },
      {
        type: 'paragraph',
        text: `Many website owners are still using "old school" tactics that actually make it harder for the AI to understand and feature their content. If you aren't sure how to fix these, partnering with a dedicated `,
        link: {
          text: 'AI SEO agency',
          url: '/services/ai-seo',
        },
        textAfter: ` can help audit your site for these common pitfalls:`,
      },
      ...
      {
        type: 'heading',
        text: 'What You Should Do to Stay Visible?',
      },
      {
        type: 'paragraph',
        text: `The good news is that you don't need expensive software or a degree in computer science to stay relevant. You just need to make your website more "scannable" and helpful.`,
      },
      {
        type: 'ordered-list',
        items: [
      ...
      },
      {
        type: 'paragraph',
        text:
          'SEO is not dying; it is simply growing up. While Google AI Overviews might mean fewer clicks for simple questions, they provide a massive opportunity for small business owners to be seen as experts.',
      },
      {
        type: 'paragraph',
        text:

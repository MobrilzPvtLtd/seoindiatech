  ...
  const tools = [
    {
      ...
      description: 'Complete CRM platform with marketing, sales, and service automation'
    },
    {
      name: 'Webflow',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Tools we use to make things <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 relative">
              easier
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
            We leverage industry-leading platforms to deliver efficient, scalable solutions for your business needs.
          </p>
        </div>
          ...
          {tools.map((tool, index) => (
            ...
            >
              ...
              <div className="hidden absolute inset-0 bg-gradient-to-br from-blue-600/90 to-purple-600/90 dark:from-blue-700/95 dark:to-purple-700/95 opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col items-center justify-center p-6 text-white">
                ...
                <p className="text-sm font-medium text-blue-100 dark:text-blue-200 mb-3">{tool.category}</p>
                <p className="text-center text-sm text-white/90">{tool.description}</p>

    ...
    <section className="bg-white dark:bg-background py-20 px-6 lg:py-28">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-5 text-xl text-muted max-w-4xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          {/* Local SEO Card */}
          <div className="group relative bg-gradient-to-br from-cream to-indigo-50 dark:from-gray-700 dark:to-surface rounded-3xl p-10 lg:p-12 overflow-hidden border border-primary/20 hover:shadow-2xl transition-all duration-500">
            <div className="absolute top-0 right-0 w-64 h-64 bg-primary/10 rounded-full blur-3xl opacity-40 -z-10 group-hover:opacity-60 transition-opacity"></div>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-2xl font-bold text-heading">
                Local SEO Services:{' '}
                <span className="text-primary">Own Your Neighborhood</span>
              </h3>
            </div>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-primary hover:bg-primary-hover text-white font-semibold px-8 py-4 rounded-full transition shadow-lg hover:shadow-xl"
            >
          ...
          {/* E-Commerce SEO Card */}
          <div className="group relative bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-gray-700 dark:to-surface rounded-3xl p-10 lg:p-12 overflow-hidden border border-emerald-100 hover:shadow-2xl transition-all duration-500">
        ...
        <div className="mt-20 text-center">
          <p className="text-2xl font-semibold text-heading dark:text-gray-100 mb-4">

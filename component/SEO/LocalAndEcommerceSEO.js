...
import { MapPin, Store, ShoppingCart, Search, Star, ArrowRight, Globe, Package } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-5 text-xl text-gray-600 max-w-4xl mx-auto">
            Whether you're a local business wanting to dominate your neighborhood or an online store focused on sales — 
            we have tailored SEO strategies built exactly for your goals.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          {/* Local SEO Card */}
          <div className="group relative bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-10 lg:p-12 overflow-hidden border border-blue-100 hover:shadow-2xl transition-all duration-500">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900">
                Local SEO Services: <span className="text-blue-600">Own Your Neighborhood</span>
              </h3>
            </div>

            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              If your business serves a specific geographic market, our local SEO services are designed just for you. 
              We optimize your <strong>Google Business Profile</strong>, ensure perfect NAP consistency (Name, Address, Phone), 
              and create localized content that resonates with nearby customers.
            </p>
          ...
          {/* E-Commerce SEO Card */}
          <div className="group relative bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl p-10 lg:p-12 overflow-hidden border border-emerald-100 hover:shadow-2xl transition-all duration-500">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900">
                E-Commerce SEO That <span className="text-emerald-600">Drives Sales</span>
              </h3>
            </div>

            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              For online retailers, our SEO solutions are laser-focused on <strong>conversions</strong>. 
              We optimize every element of your store to attract qualified traffic and turn visitors into paying customers.
            </p>
        ...
        <div className="mt-20 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 text-gray-600">
            <div className="flex items-center gap-2"><Globe className="w-5 h-5" /> 500+ Optimized Listings</div>
            <div className="flex items-center gap-2"><Store className="w-5 h-5" /> 200+ Local Clients</div>
            <div className="flex items-center gap-2"><Search className="w-5 h-5" /> Top 3 Rankings Achieved</div>
          </div>
        </div>

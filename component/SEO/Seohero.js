    ...
    <section className="bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-blue-950/30 py-12 md:py-16 px-6 md:px-8 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-center items-center gap-10 lg:gap-20 relative z-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-md max-w-xl mx-auto md:mx-0 px-2 md:px-0">
            ...
            loyal customers. At{' '}
            <span className="text-blue-700 dark:text-blue-400 font-semibold">Digitalyzeit,</span>{' '}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mt-8 max-w-xl mx-auto md:mx-0">
            {[
              {icon: <Search className="w-4 h-4" />, text: "Organic Rankings"},
              {icon: <Globe className="w-4 h-4" />, text: "Local SEO"},
              {icon: <BarChart className="w-4 h-4" />, text: "Technical Optimization"},
              {icon: <ArrowRight className="w-4 h-4" />, text: "Conversion Rate Focus"},
            ].map((item, index) => (
        ...
        <div className="w-full md:w-1/2 flex justify-center relative">
          ...
          <div className="absolute z-10 -bottom-6 -left-6 md:bottom-12 md:left-0 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hidden md:block">
            <div className="text-blue-600 dark:text-blue-400 font-bold text-xl">91%</div>
            <div className="text-gray-600 dark:text-gray-400 text-xs">Higher visibility</div>
          </div>
          ...
          <div className="absolute z-10  -top-6 -right-6 md:top-12 md:right-0 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 hidden md:block">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-800 dark:text-gray-200 font-medium text-sm">Top keywords</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="hidden max-w-7xl mx-auto mt-16 relative z-10">
        <div className="text-center">
          <p className="text-gray-500 dark:text-gray-400 text-sm font-medium uppercase tracking-wider mb-6">Trusted by industry leaders</p>
          <div className="flex flex-wrap justify-center gap-8 opacity-70">
            {['Google', 'Microsoft', 'Adobe', 'Shopify', 'Amazon'].map((brand, index) => (

...
const Seohero = () => {
  return (
    <section className="bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-blue-950/30 pt-24 md:pt-28 pb-8 md:pb-16 px-6 md:px-8 overflow-hidden relative">

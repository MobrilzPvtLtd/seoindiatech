      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-xl p-8 md:p-16">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mt-8">
            <button className="hidden bg-gradient-to-r from-blue-600 to-blue-800 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 text-white px-6 py-3 rounded-full text-base font-medium transition flex items-center justify-center group shadow-lg">
              Get Started Now

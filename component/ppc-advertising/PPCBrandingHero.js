...
export default function PPCBrandingHero() {
  return (
    <section className="bg-gray-100 py-16 px-6 lg:py-24 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Main Headline */}
        <div className="text-center mb-16">
          <h3 className="text-4xl lg:text-6xl font-bold text-gray-800 leading-tight">
        ...
        {/* Why Choose Us */}
        <div className="bg-white rounded-3xl shadow-lg p-10 lg:p-16 mb-20">
          <h2 className="text-3xl lg:text-5xl font-bold text-gray-800 text-center mb-4">
            ...
            {[
              {
                ...
                desc: "Years of managing high-performing Google PPC campaigns across industries.",
              },
              {
                icon: Target,
                title: "Tailored Strategies",
                desc: "Custom campaigns — no generic templates. Designed to maximize your ROI.",
              },
              {
                icon: MessageSquare,
                title: "Transparent Reports",
                desc: "Detailed insights on clicks, conversions, and ROI — always know where your money goes.",
              },
              {
                icon: Zap,
                title: "Budget Optimization",
                desc: "Efficient spend with zero waste. Get more leads without overspending.",
              },
              {
                icon: Shield,
                title: "Complete Digital Support",
                desc: "PPC + Local SEO + Content + Branding — a full-stack growth solution.",
              },
              {
                icon: ArrowRight,
                title: "Holistic Integration",
                desc: "PPC works seamlessly with SEO, CRO, landing pages, and branding.",
              },
            ].map((item, i) => (

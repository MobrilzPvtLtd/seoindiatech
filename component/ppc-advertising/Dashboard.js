...
import { BarChart2, PieChart, TrendingUp, Activity, Monitor, LayoutDashboard } from 'lucide-react';
  ...
  const dashboardFeatures = [
    {
      ...
      description: "Track all your key metrics in one place with intuitive visualizations"
    },
    {
      icon: <PieChart className="w-5 h-5 text-blue-600 dark:text-blue-400" />,
      title: "Performance Reports",
      description: "Generate detailed reports on campaign performance and ROI"
    },
    {
      icon: <TrendingUp className="w-5 h-5 text-blue-600 dark:text-blue-400" />,
      title: "Growth Tracking",
      description: "Monitor your progress and identify new growth opportunities"
    },
    {
      icon: <Activity className="w-5 h-5 text-blue-600 dark:text-blue-400" />,
      title: "Real-Time Updates",
      description: "Stay informed with live data and instant notifications"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-lg max-w-3xl mx-auto mb-8">
            Gain valuable insights with our powerful, intuitive dashboard that brings all your marketing data together in one place.
          </p>
        </div>

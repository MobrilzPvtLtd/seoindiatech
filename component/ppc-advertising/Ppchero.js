  ...
  return (
    <section className="bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-blue-950/30 px-4 py-16 md:py-20 lg:py-24 relative overflow-hidden">
      ...
      <div className="absolute top-20 right-20 hidden lg:block">
        <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-blue-200 dark:text-blue-900 opacity-30">
          <circle cx="30" cy="30" r="30" fill="currentColor" />
        </svg>
      </div>
      
      <div className="absolute bottom-20 left-20 hidden lg:block">
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-indigo-200 dark:text-indigo-900 opacity-30">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <p className="text-gray-700 dark:text-gray-300 text-lg md:text-xl mb-10 max-w-4xl mx-auto">
          At <span className="font-semibold text-gray-900 dark:text-white">Digitalyzeit</span>, we don't just run ads—we create <span className="font-semibold text-gray-900 dark:text-white">high-converting, precision-targeted campaigns</span> that generate real business results.
          Our <span className="font-semibold text-gray-900 dark:text-white">Pay-Per-Click (PPC) advertising solutions</span> ensure your brand appears in front of the right audience, at the right time, with the right message.
        </p>

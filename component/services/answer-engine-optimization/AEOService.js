  ...
  return (
    <section className="bg-white dark:bg-gray-950 py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        {/* Heading */}
        <h2 className="text-3xl sm:text-4xl font-bold text-center text-heading mb-6">
          What you get with our AEO answer engine optimization services
        </h2>

        <p className="text-lg text-muted text-center max-w-3xl mx-auto mb-14">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-background p-6 rounded-xl border border-gray-200 dark:border-gray-800">
            <div className="flex items-center gap-3 mb-3">
              <span className="w-8 h-8 flex items-center justify-center rounded-full bg-primary text-white text-sm font-semibold">
                1
              </span>
          ...
          {/* 5 */}
          <div className="bg-background p-6 rounded-xl border border-gray-200 dark:border-gray-800 md:col-span-2">
            <div className="flex items-center gap-3 mb-3">
              <span className="w-8 h-8 flex items-center justify-center rounded-full bg-primary text-white text-sm font-semibold">
                5
              </span>

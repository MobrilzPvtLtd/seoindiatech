...
export default function AEOHero() {
  return (
    <section className="bg-background pt-24 md:pt-28 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8">
        {/* Text Content */}
        <div className="w-full lg:w-1/2">
          <h1 className="text-4xl sm:text-5xl font-bold text-heading mb-6">
            Answer Engine Optimization Agency
          </h1>
          <p className="text-lg sm:text-xl text-body mb-4 text-justify">
          ...
          <p className="text-lg sm:text-xl text-body text-justify">

  ...
  return (
    <section className="relative w-full py-14 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 via-white to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 overflow-hidden">
      <div className="max-w-6xl mx-auto relative z-10">
        {/* Heading */}
        <h3 className="text-2xl sm:text-3xl font-semibold text-heading mb-6 leading-snug">
          Answer engine optimization consulting for brands that want faster
          clarity
        </h3>

        {/* Intro Content */}
        <div className="space-y-4 text-muted text-sm sm:text-base leading-relaxed max-w-3xl">
          <p>
        ...
        <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {[
            ...
            <div
              key={index}
              className="group flex items-start gap-3 bg-white/80 dark:bg-background/70 backdrop-blur-md border border-gray-200 dark:border-gray-800 rounded-2xl p-5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              <div className="mt-1 text-primary dark:text-accent text-lg">
                <FaCheckCircle />
              </div>
        ...
        {/* Closing Paragraph */}
        <div className="mt-10 text-muted text-sm sm:text-base leading-relaxed max-w-4xl space-y-4">
          <p>
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-primary/10 blur-3xl rounded-full pointer-events-none"></div>
    </section>
  )
}

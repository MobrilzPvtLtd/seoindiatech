...
const items = [
  {
    ...
    text:
      'We find the words your buyers type. We choose words that lead to sales. Then we map them to pages on your site so each page has a clear goal.',
  },
  {
    icon: Activity,
    title: 'Site Health Check',
    text:
      'If your site has errors or slow pages, search engines may ignore it. We check your site for issues and fix them. We improve page load speed and site navigation.',
  },
  {
    icon: FileText,
    title: 'On-Page Work',
    text:
      'We make sure your product pages and category pages have clear titles, descriptions, images, and content. We write text that helps search engines and customers understand what you sell.',
  },
  {
    icon: Link2,
    title: 'Link Growth',
    text:
      'We help your store earn links from sites that matter. Good links bring more credibility. More credibility usually means higher rankings.',
  },
  {
    icon: MapPin,
    title: 'Local SEO for Stores',
    text:
      'If you sell locally, we help you rank in local searches. We set up local listings and make sure your store appears in maps and local search results.',
  },
  {
    icon: BarChart3,
    title: 'Monthly Progress Reports',
    text:
      'Each month you receive a clear report. You can see what improved, what works, and what direction we take next.',
  },
]
          ...
          <div className="relative p-8 md:p-12">
            ...
            <div className="space-y-5 text-gray-600 dark:text-gray-300 text-justify leading-relaxed text-lg">
              <p>
                ...
                engines. Once pages rank, they can keep bringing traffic without
                paying for every click.
              </p>

              <p>
                Ranking well also builds trust. People trust stores that appear
                on the first page. That trust leads to more clicks, more leads,
                and more sales.
              </p>
            </div>
          </div>

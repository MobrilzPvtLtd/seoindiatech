    ...
    <>
      <section className="relative py-28 px-6 md:px-12 lg:px-24 bg-white dark:bg-black overflow-hidden transition-colors duration-300">
        <div className="max-w-6xl mx-auto">
          {/* Heading */}
          <h4 className="text-4xl md:text-5xl font-bold text-center mb-20 text-heading">
          ...
          <div className="grid md:grid-cols-2 gap-20">
            ...
            <div className="relative group">
              <div className="absolute -top-10 left-0 text-8xl font-bold text-gray-100 dark:text-neutral-900 group-hover:text-white/900/20 transition-all duration-300">
                01
              </div>
              <div className="relative z-10">
                <h5 className="text-2xl font-semibold mb-6 text-heading">
                ...
                <div className="mt-6 h-[3px] w-20 bg-gradient-to-r from-primary to-secondary rounded-full"></div>
              </div>
            </div>
      ...
      <section className="relative py-1 px-6 md:px-12 lg:px-24 bg-gray-50 dark:bg-black transition-colors duration-300">
        <div className="max-w-4xl mx-auto text-center">
          {/* Small Heading */}
          <h6 className="text-sm uppercase tracking-[0.3em] font-semibold text-primary dark:text-accent mb-6">
            WHY SEO INDIA TECH
          </h6>

          {/* Main Content */}
          <p className="text-xl md:text-2xl leading-relaxed text-heading dark:text-gray-300 font-medium">
          ...
          {/* Decorative Line */}
          <div className="mt-10 mx-auto h-[3px] w-24 bg-gradient-to-r from-primary to-secondary rounded-full"></div>
        </div>
      </section>
    </>
  )

  ...
  return (
    <section className="relative w-full py-24 px-4 md:px-10 bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        {/* Left Content */}
        <div>
          <h1 className="text-3xl md:text-5xl font-bold text-heading leading-tight mb-8">
            <span className="text-primary dark:text-accent">App Store Optimization</span> Services India
          </h1>

          <div className="space-y-6 text-body text-base md:text-lg leading-relaxed text-justify">
            <p>
            ...
            <p>
              <Link href="/" className="text-primary dark:text-accent font-semibold hover:underline">
                SEO India Tech
              </Link>{' '}

      ...
      <section className="w-full py-24 bg-white dark:bg-gray-950">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="relative">
            {/* Vertical Line */}
            <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-1 bg-primary/10 dark:bg-primary/20 h-full"></div>

            <div className="space-y-16">
              {/* Step 1 */}
              <div className="relative md:flex items-center md:justify-between">
                <div className="md:w-5/12 bg-background p-8 rounded-2xl shadow-md">
                  <h5 className="text-lg font-semibold text-primary dark:text-accent mb-4">
                ...
                <div className="hidden md:flex items-center justify-center w-12 h-12 rounded-full bg-primary text-white font-bold absolute left-1/2 transform -translate-x-1/2">
                  01
                </div>
              </div>
      ...
      <section className="w-full py-20 bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-10">
            {/* Card 1 */}
            <div className="relative bg-white/70 dark:bg-background/60 backdrop-blur-sm p-8 md:p-10 rounded-3xl shadow-lg border border-border dark:border-gray-800">
              {/* Accent Border */}
              ...
              <div className="pl-6 space-y-6">
                ...
                <div className="flex items-center gap-4">
                  <div className="bg-primary/10 dark:bg-primary/20/40 p-3 rounded-xl">
                    <FaUsers className="text-primary dark:text-accent text-lg" />
                  </div>

                  <h5 className="text-xl md:text-2xl font-semibold text-heading">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={index} className="flex items-start gap-3">
                      <FiCheckCircle className="min-w-[22px] min-h-[22px] text-primary dark:text-accent mt-1" />
                      <span className="text-muted text-justify leading-relaxed">
                        {item}
                      </span>
                    </li>
                  ))}
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="relative bg-white/70 dark:bg-background/60 backdrop-blur-sm p-8 md:p-12 rounded-3xl shadow-lg border border-border dark:border-gray-800">
            ...
            <div className="pl-6 space-y-6">
              ...
              <div className="flex items-center gap-4">
                <div className="bg-primary/10 dark:bg-primary/20/40 p-3 rounded-xl">
                  <FaMapMarkedAlt className="text-primary dark:text-accent text-xl" />
                </div>

                <h6 className="text-xl md:text-2xl font-semibold text-heading">
              ...
              <div>
                <Link
                  href="/contact-us"
                  className="inline-block mt-4 px-6 py-3 bg-primary hover:bg-primary-hover text-white rounded-xl font-medium transition-all duration-300 shadow-md hover:shadow-lg"
                >
                  Contact Us
                </Link>
              </div>

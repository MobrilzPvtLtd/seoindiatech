    ...
    <section className="relative w-full py-28 px-6 bg-gradient-to-b from-white via-gray-50 to-white dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          <h3 className="text-4xl md:text-5xl font-bold text-heading">
            What you get from our AI SEO services
          </h3>
          <p className="mt-6 text-lg text-body text-justify">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          {/* Card 1 */}
          <div className="group bg-white dark:bg-background border border-gray-200 dark:border-gray-800 rounded-3xl p-10 shadow-lg hover:shadow-2xl transition duration-500 hover:-translate-y-2">
            <div className="flex items-center gap-5 mb-6">
              <div className="w-14 h-14 flex-shrink-0 flex items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-secondary text-white text-2xl group-hover:scale-110 transition">
                <FiSearch />
              </div>
          ...
          <div className="group bg-white dark:bg-background border border-gray-200 dark:border-gray-800 rounded-3xl p-10 shadow-lg hover:shadow-2xl transition duration-500 hover:-translate-y-2">
            <div className="flex items-center gap-5 mb-6">
              <div className="w-14 h-14 flex-shrink-0 flex items-center justify-center rounded-2xl bg-gradient-to-br from-cream0 to-pink-600 text-white text-2xl group-hover:scale-110 transition">
                <FiHelpCircle />
              </div>
              <h3 className="text-2xl font-semibold text-heading">

...
export default function SmallBusinessWhatYouGet() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-14 relative">
          ...
          <div className="relative group bg-gray-50 dark:bg-gray-900 p-10 md:p-12 rounded-3xl shadow-lg border-l-4 border-blue-500 dark:border-blue-400 overflow-hidden hover:shadow-2xl transition-all duration-500">
            ...
            <div className="space-y-6 text-lg text-gray-700 dark:text-gray-300 leading-relaxed text-justify">
              <p>
                ...
                strong local signals. When these work together, your site has a
                better chance to appear for the keywords your customers type.
              </p>

              <p>
                Our process starts with research. We review what people search
                for in your city or service area. We look at your top
                competitors and the pages that rank for them. Then we map the
                best terms to the right pages. This is how SEO services for
                small businesses stay focused and avoid wasted effort.
              </p>

              <p>
                Next comes on page work. We improve page titles, headings,
                internal links, image text, and page structure. We also fix
                issues that block search engines, like broken links, duplicate
                pages, slow load times, and confusing navigation. These are core
                steps in small business SEO services because they help search
                engines understand your site and help users move faster.
              </p>
            </div>
          </div>
          ...
          <div className="relative group bg-gray-50 dark:bg-gray-900 p-10 md:p-12 rounded-3xl shadow-lg border-l-4 border-indigo-500 dark:border-indigo-400 overflow-hidden hover:shadow-2xl transition-all duration-500">
            ...
            <div className="space-y-6 text-lg text-gray-700 dark:text-gray-300 leading-relaxed text-justify">
              ...
              <p>
                If you want a reliable local SEO service company, look for one
                that does not hide behind vague promises. We share the
                checklist, show the before and after, and keep the work tied to
                rankings, calls, and form leads.
              </p>
            </div>
          </div>
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-5 text-gray-700 dark:text-gray-300 text-justify text-lg leading-relaxed">
                  ...
                  <p>
                    ...
                    into page growth and content expansion. You might need a
                    service page for each location, a set of pages for your key
                    services, or a better structure for product categories. As a
                    small business SEO agency, we keep priorities tight so you
                    see progress without delay.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-5 text-gray-700 dark:text-gray-300 text-justify text-lg leading-relaxed">
                  <p>
                    ...
                    search terms, and clean site structure. Our ecommerce SEO
                    services focus on category planning, product content,
                    filters, schema, internal linking, and technical cleanup.
                  </p>
                  <p>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-5 text-gray-700 dark:text-gray-300 text-justify text-lg leading-relaxed">
                ...
                <ul className="list-disc marker:text-blue-500 dark:marker:text-green-400 pl-6 space-y-3">
                  ...
                  <li>
                    Local SEO for small business that lifts map visibility
                  </li>
                  <li>Content that answers real questions customers ask</li>
                  <li>
                    Monthly reporting that shows rankings, traffic, and leads
                  </li>
                </ul>
                <p>
                  If you want a small business SEO agency that keeps it simple,
                  we are a strong fit. If you want an SEO company for small
                  business that explains every step in plain language, we do
                  that too.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative bg-white dark:bg-gray-900 rounded-3xl overflow-hidden p-12 md:p-16 shadow-[0_20px_60px_rgba(0,0,0,0.08)] hover:shadow-[0_25px_80px_rgba(0,0,0,0.12)] transition-all duration-500 border border-gray-200/60 dark:border-gray-800 hover:-translate-y-2">
            ...
            <div className="relative z-10 space-y-6 text-gray-700 dark:text-gray-300 text-justify text-lg leading-relaxed">
              ...
              <p>
                If your phone is not ringing from search, or your website
                traffic feels random, small business SEO services can change
                that. Start with a plan that matches how your customers search.
                Build local visibility with local SEO services for small
                business. Add growth pages with SEO services for small
                businesses. And if you sell online, add ecommerce SEO services
                for long term sales.
              </p>

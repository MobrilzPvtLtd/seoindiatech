      ...
      <div className="relative max-w-6xl mx-auto space-y-16 md:space-y-20">
        ...
        <div className="text-center space-y-6">
          <div className="flex justify-center">
            <div className="p-5 rounded-full bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-primary/20/40 dark:to-indigo-900/40 text-primary dark:text-accent shadow-lg">
              <FaChartLine size={40} />
            </div>
          </div>
        ...
        <div className="space-y-10 md:space-y-14">
          ...
          <ul className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
            <li className="group flex items-start gap-5 p-7 rounded-2xl bg-white/80 dark:bg-background/70 backdrop-blur-md border border-gray-200/60 dark:border-gray-800/60 shadow-md hover:shadow-xl hover:border-blue-400/50 dark:hover:border-primary/50 transition-all duration-300 hover:-translate-y-1">
              <FaBrain
            ...
            <li className="group flex items-start gap-5 p-7 rounded-2xl bg-white/80 dark:bg-background/70 backdrop-blur-md border border-gray-200/60 dark:border-gray-800/60 shadow-md hover:shadow-xl hover:border-indigo-400/50 dark:hover:border-indigo-600/50 transition-all duration-300 hover:-translate-y-1">
              <FaBrain
            ...
            <li className="group flex items-start gap-5 p-7 rounded-2xl bg-white/80 dark:bg-background/70 backdrop-blur-md border border-gray-200/60 dark:border-gray-800/60 shadow-md hover:shadow-xl hover:border-blue-400/50 dark:hover:border-primary/50 transition-all duration-300 hover:-translate-y-1 col-span-full sm:col-span-1 lg:col-span-1">
              <FaBrain
                className="text-primary dark:text-primary flex-shrink-0 mt-1.5"
                size={28}
              />

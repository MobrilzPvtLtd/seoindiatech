...
export default function GEOHero() {
  return (
    <section className="relative w-full bg-gradient-to-b from-white to-gray-50 dark:from-background dark:to-gray-950 pt-24 md:pt-28 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-heading leading-tight">
            <span className="text-primary dark:text-accent">Generative Engine Optimization</span> Agency
          </h1>
        ...
        <div className="relative w-full h-80 sm:h-96 md:h-[420px] flex items-center justify-center">
          <div className="absolute inset-0 bg-primary/10 dark:bg-accent/5 blur-3xl rounded-full"></div>

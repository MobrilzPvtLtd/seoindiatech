  ...
  return (
    <section className="py-16 sm:py-20 bg-background">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-card dark:bg-card rounded-2xl shadow-sm hover:shadow-md transition p-6 sm:p-8 md:p-10">
          
          {/* Heading */}
          <h5 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4 text-heading">
            Why choose SEO India Tech
          </h5>

          {/* Content */}
          <p className="text-body text-sm sm:text-base md:text-lg leading-7 text-justify mb-6">
          ...
          <Link href="/contact-us">
            <button className="bg-primary hover:bg-primary-hover text-white cursor-pointer font-semibold py-3 px-6 rounded-lg transition duration-300">
              Talk to Our Team
            </button>
          </Link>
        </div>

  ...
  return (
    <section className="px-6 md:px-12 py-16 bg-background">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
        {/* Left Card */}
        <div className="bg-card dark:bg-card rounded-xl p-8 shadow-sm hover:shadow-md transition duration-300">
          ...
          <p className="text-body text-base md:text-lg leading-7 mb-3 text-justify">

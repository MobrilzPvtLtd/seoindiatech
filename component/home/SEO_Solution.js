  ...
  return (
    <div className="relative" style={{ width: size, height: size }}>
      <svg className="w-full h-full transform -rotate-90" viewBox="0 0 32 32">
        <circle cx="16" cy="16" r={radius} stroke="#E5E7EB" className="dark:stroke-gray-700" strokeWidth="4" fill="none" />
        <circle
          cx="16"
          cy="16"
          r={radius}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <p className="mt-5 max-w-3xl mx-auto text-gray-600 dark:text-gray-300 text-lg">
            Drive organic traffic, improve visibility, and achieve higher rankings with our expert SEO strategies.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8">
          ...
          <article className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 border border-gray-100 dark:border-gray-700 overflow-hidden">
            <header className="mb-6">
              <h2 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-3">Email Verification</h2>
          ...
          <article className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 border border-gray-100 dark:border-gray-700 overflow-hidden">
            <header className="mb-6">
              <h2 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-3">Competitor Analysis</h2>
              <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
          ...
          <article className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-6 md:col-span-2 xl:col-span-1 border border-gray-100 dark:border-gray-700 overflow-hidden">
            <header className="mb-6">
              <h2 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-3">Revenue Monitoring</h2>
              <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">

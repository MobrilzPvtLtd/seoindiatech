...
const Socialmediastrategies = () => {
  const strategies = [
    ...
    },
    {
      ...
      description:
        'Engagement is the heartbeat of social media. We develop strategies that foster genuine interactions with your audience.',
    ...
    },
    {
      ...
      description:
        'In the era of influencer marketing, we understand the power of partnerships and connect you with the right voices.',
    ...
    },
    {
      ...
      description:
        'Stay relevant with our rapid response marketing that helps your brand capitalize on trending topics and conversations.',
    ...
    },
    {
      ...
      description:
        'Scale your social presence with customized growth strategies designed for sustainable, long-term expansion.',
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {strategies.map((strategy, index) => (
            ...
            >
              <div className="p-6">
                <div
                  className={`inline-flex items-center justify-center p-3 rounded-lg mb-5 ${strategy.iconBg}`}
                >
                  {strategy.icon}
                </div>

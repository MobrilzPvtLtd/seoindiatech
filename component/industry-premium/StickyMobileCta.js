...
export default function StickyMobileCta({ label = 'Book Free Consultation', href = '/contact-us' }) {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-border bg-white/95 dark:bg-secondary/95 backdrop-blur-md safe-bottom px-3 pt-3 lg:hidden">
      <Link
        href={href}

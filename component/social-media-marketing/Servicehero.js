      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 lg:gap-12 relative z-10">
        ...
        <div className="max-w-xl space-y-6 w-full md:w-1/2">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <button className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors shadow-md flex items-center justify-center gap-2 group">
              Get started now
              <ArrowRight className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-1" />
            </button>
            
            <button className="bg-transparent text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors flex items-center justify-center">
              Explore Services
            </button>
          </div>

...
const benefits = [
  { icon: TrendingUp,    text: "Improved brand recognition across all major platforms" },
  { icon: MessageCircle, text: "Higher engagement rates with meaningful user interactions" },
  { icon: MousePointerClick, text: "Increased website traffic and better conversion potential" },
  { icon: Heart,         text: "Enhanced customer relationships through active communication" },
  { icon: BarChart3,     text: "Greater market insights to understand audience behavior" },
  { icon: Shield,        text: "A strong online reputation that supports long-term success" },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            ...
            <strong className="text-blue-700">social media marketing services India</strong> that drive actual business growth.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl border border-blue-100 hover:border-blue-300 transition-all duration-500 hover:-translate-y-3"
              >
        ...
        <div className="mt-16 text-center max-w-4xl mx-auto">
          <p className="text-2xl font-semibold text-blue-900 leading-relaxed">
            ...
            <span className="text-blue-600 underlin">
              short-term boosts
            </span>{' '}
            and{' '}

    ...
    <section className="py-20 bg-white dark:bg-background">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl dark:text-gray-100 text-muted max-w-4xl mx-auto leading-relaxed">
            As a leading{' '}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative bg-card dark:bg-card rounded-2xl p-8 shadow-lg hover:shadow-2xl border border-border hover:border-indigo-200 transition-all duration-500 hover:-translate-y-4"
              >
                {/* Icon */}
                <div className="w-16 h-16 mb-6 rounded-2xl bg-primary-hover flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="text-center mt-16">
          <a
            href="/contact-us"
            className="inline-flex items-center px-10 py-5 bg-primary-hover hover:bg-blue-800 text-white font-bold text-lg rounded-full shadow-2xl hover:shadow-indigo-500/50 transform hover:scale-105 transition-all duration-300"
          >

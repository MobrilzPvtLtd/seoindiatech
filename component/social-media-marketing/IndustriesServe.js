      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            As a seasoned{' '}
            <span className="font-semibold text-blue-700">social media marketing services company</span>
            , we work with businesses across diverse sectors — helping every brand stand out and grow.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
          {industries.map((industry, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative bg-white rounded-2xl p-10 shadow-md hover:shadow-2xl border border-gray-100 hover:border-blue-200 transition-all duration-400 hover:-translate-y-4 text-center"
              >
                {/* Icon */}
        ...
        <div className="mt-16 text-center">
          <p className="text-2xl font-medium text-gray-800 max-w-4xl mx-auto">
            No matter your industry, our{' '}
            <span className="text-blue-600 font-bold">social media marketing services</span>{' '}
            ensure your brand{' '}
            <span className="">captures attention</span>{' '}

...
export default function AutomationServices() {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        'Optimize your marketing with automated emails, AI-powered delivery, and data-backed insights for maximum ROI.',
      color:
        'bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/30',
      hoverColor:
        'hover:from-green-100 hover:to-emerald-200 dark:hover:from-green-800/40 dark:hover:to-emerald-800/40',
    ...
    },
    {
      ...
      description:
        'Enhance efficiency by automating approvals, managing tasks, and improving team collaboration.',
      color:
        'bg-gradient-to-br from-orange-50 to-yellow-100 dark:from-orange-900/30 dark:to-yellow-900/30',
      hoverColor:
        'hover:from-orange-100 hover:to-yellow-200 dark:hover:from-orange-800/40 dark:hover:to-yellow-800/40',
    ...
    },
    {
      ...
      description:
        'Implement RPA to automate data entry, invoice processing, and other repetitive back-office tasks with precision.',
      color:
        'bg-gradient-to-br from-teal-50 to-cyan-100 dark:from-teal-900/30 dark:to-cyan-900/30',
      hoverColor:
        'hover:from-teal-100 hover:to-cyan-200 dark:hover:from-teal-800/40 dark:hover:to-cyan-800/40',

  ...
  const automationSteps = [
    {
      ...
      description:
        'Spot repetitive tasks, manual workflows, and inefficiencies ideal for automation.',
    },
    {
      icon: <Code className="w-6 h-6 text-blue-600 dark:text-blue-400" />,
      title: 'Select the Right Automation Tools',
      description:
        'Choose the right technology—software, APIs, RPA, or AI systems—to automate each task effectively.',
    },
    {
      icon: <Clipboard className="w-6 h-6 text-blue-600 dark:text-blue-400" />,
      title: 'Develop an Implementation Plan',
      description:
        'Develop a detailed implementation plan with timelines, resource allocation, and measurable success metrics.',
    },
    {
      icon: (
      ...
      description:
        'Ensure your automation solution works flawlessly through thorough testing in a controlled environment.',
    },
    {
      icon: <ArrowRight className="w-6 h-6 text-blue-600 dark:text-blue-400" />,
      title: 'Deploy and Monitor',
      description:
        'Execute your automation strategy while continuously observing and refining for maximum efficiency.',
    },
  ]

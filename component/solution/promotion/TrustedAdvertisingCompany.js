...
import { Sparkles, Target, TrendingUp, Users, Megaphone, ShieldCheck, ArrowRight } from "lucide-react";
...
export default function TrustedAdvertisingCompany() {
  ...
  return (
    <section className="py-24 px-6 bg-gradient-to-b from-blue-50 via-white to-indigo-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-5xl mx-auto leading-relaxed">
            ...
            <strong>creativity, technology, and strategy</strong> to deliver high-performance promotional solutions. 
            Our experienced team analyzes your competitors, understands market trends, and studies your audience behavior 
            to build campaigns that deliver <span className="text-blue-600 font-bold">powerful outcomes</span>.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {benefits.map((item, index) => (
            <div
              key={index}
              className="group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-400 border border-gray-100 hover:border-blue-200 hover:-translate-y-2"
            >
        ...
        <div className="text-center mb-12">
          <p className="text-xl text-gray-700 max-w-4xl mx-auto">
            From creative ad design to platform selection and performance monitoring — 
            our team manages the <strong>entire process seamlessly</strong>.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-blue-700 rounded-3xl p-12 md:p-20 text-white overflow-hidden relative">
          ...
          <div className="relative z-10 max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl opacity-95 leading-relaxed mb-12 max-w-4xl mx-auto">
              Your brand is more than just a logo — it is an emotional and strategic representation of your business. 
              Our advertising & brand promotion solutions help you create a{" "}
              <strong>strong identity that connects deeply</strong> with your audience and builds long-term trust.
            </p>

            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {brandFocus.map((item, i) => (
                <div key={i} className="flex items-center gap-4 bg-white/15 backdrop-blur-sm rounded-xl p-6 hover:bg-white/25 transition-all duration-300">
            ...
            <p className="mt-12 text-xl font-medium opacity-95">
              Whether you’re targeting local customers or building a nationwide audience — 
              we help your business build <span className="text-yellow-300 font-bold">credibility and influence</span>.
            </p>
          </div>
        </div>
        ...
        <div className="text-center mt-20">
          ...
          <p className="text-xl text-gray-600 mb-10">
            Let’s build advertising & promotion campaigns that don’t just get seen — they get <strong>results</strong>.
          </p>

          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link href={'/contactus'} className="group inline-flex items-center gap-4 bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-bold text-lg px-10 py-5 rounded-full shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">

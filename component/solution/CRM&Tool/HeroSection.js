        ...
        <div className="flex flex-col md:flex-row md:items-center gap-12 md:gap-16 lg:gap-24">
          ...
          <div className="md:w-1/2 space-y-6">
            ...
            <p className="text-gray-700 text-justify dark:text-gray-300 text-base md:text-lg leading-relaxed">
              Our CRM and management tools go beyond software, serving as
              powerful catalysts for transformation. From strengthening customer
              relationships to streamlining workflows and boosting team
              collaboration, our solutions are designed to drive your
              organization toward measurable success.
            </p>

    ...
    <>
      ...
      <section className="py-20 bg-white dark:bg-background transition-colors duration-300">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-10">
            <h5 className="text-2xl sm:text-3xl font-bold text-heading">
              Support Beyond Implementation
            </h5>
          </div>

          <p className="text-heading dark:text-gray-300 leading-relaxed mb-8 text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <div className="p-6 bg-cream dark:bg-card rounded-2xl shadow-md">
              <p className="text-heading font-medium">
            ...
            <div className="p-6 bg-cream dark:bg-card rounded-2xl shadow-md lg:col-span-2">
              <p className="text-heading font-medium">
          ...
          <p className="text-heading dark:text-gray-300 leading-relaxed mt-8 text-center">
      ...
      <section className="relative py-24 bg-background overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-96 h-96 bg-primary/15/20 dark:bg-primary/15 rounded-full blur-3xl"></div>
          <div className="absolute bottom-10 right-10 w-80 h-80 bg-accent/15 dark:bg-primary-hover/20 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-heading dark:text-gray-300 leading-relaxed mb-10">

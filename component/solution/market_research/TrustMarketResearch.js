import { CheckCheck, Headphones, BarChart2, MessageSquare, Database, TrendingUp, ArrowRight } from 'lucide-react';
...
export default function TrustMarketResearch() {
  ...
  const researchMethods = [
    {
      id: 1,
      text: "Social Media Listening: Social media platforms provide a wealth of information about consumer opinions, preferences, and trends.",
      title: "Social Media Listening",
      description: "Extract real-time consumer insights from conversations across platforms",
    ...
    {
      id: 2,
      text: "Website Analytics: Implementing web analytics tools, such as Google Analytics, to track user behavior on your website.",
      title: "Website Analytics",
      description: "Track user behavior patterns to optimize digital experiences",
    ...
    {
      id: 3,
      text: "Online Communities and Forums: Online communities and forums focused on specific industries or customer segments.",
      title: "Online Communities",
      description: "Gather insights from dedicated interest groups and industry forums",
    ...
    {
      id: 4,
      text: "Data Mining and Text Analysis: Advanced data mining and text analysis techniques can help businesses extract meaningful insights from large volumes of unstructured data.",
      title: "Data Mining & Text Analysis",
      description: "Uncover hidden patterns in large datasets with advanced algorithms",
        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className={`transform transition-all duration-700 ease-out ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-8 md:p-10 shadow-xl">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
                We Can Help You Succeed <br />By <span className="text-blue-600 dark:text-blue-400">Leveraging</span>
              </h3>
                ...
                {filteredMethods.map((method, index) => (
                  <div
                    ...
                    className={`flex items-start space-x-4 p-4 rounded-lg transform transition-all duration-300 hover:bg-gray-50 dark:hover:bg-gray-700/50 cursor-pointer border border-transparent hover:border-gray-200 dark:hover:border-gray-700 ${
                      hoveredItem === method.id ? 'bg-gray-50 dark:bg-gray-700/50 border-gray-200 dark:border-gray-700' : ''
                    } ${
                  ...
                  >
                    <div className={`flex-shrink-0 p-2 rounded-lg ${method.bgColor} transition-colors duration-300`}>
                      {method.icon}
                    </div>
                    <div>
                      <h4 className={`font-medium text-lg leading-relaxed transition-colors duration-300 ${
                        hoveredItem === method.id ? method.color : 'text-gray-800 dark:text-white'
                      }`}>
                        {method.title}
                      </h4>
          ...
          <div className={`transform transition-all duration-700 ease-out delay-200 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <div className="relative">
              ...
              <div className="absolute -bottom-6 right-0 left-0 mx-auto w-4/5 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 flex justify-between">
                <div className="text-center px-3">
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-400">Market Insights</div>
                </div>
                <div className="h-10 w-px bg-gray-200 dark:bg-gray-700"></div>
                <div className="text-center px-3">
                  <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">+53%</div>
                  <div className="text-xs text-gray-600 dark:text-gray-400">Decision Accuracy</div>
                </div>
                <div className="h-10 w-px bg-gray-200 dark:bg-gray-700"></div>
                <div className="text-center px-3">
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-3">
              {['Surveys', 'Interviews', 'Focus Groups', 'Data Mining', 'Competitor Analysis', 'Trend Research'].map((method, index) => (
                <div 
                  key={index} 

      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        <div className="flex flex-col md:flex-row md:items-center gap-12 md:gap-16 lg:gap-24">
          ...
          <div className="md:w-1/2 space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
              Market <span className="text-blue-700 dark:text-blue-400">Research</span>
            </h1>
              ...
              <div className="absolute -bottom-2 right-8 bg-white dark:bg-gray-800 px-4 py-3 rounded-lg shadow-lg border border-gray-100 dark:border-gray-700 z-20">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-lg font-bold text-blue-600 dark:text-blue-400">+82%</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className=" hidden mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={index} className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-4 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 text-center">

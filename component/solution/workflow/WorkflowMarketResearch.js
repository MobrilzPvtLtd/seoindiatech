          ...
          {[
            {
              ...
              desc:
                'No more guesswork. Every strategy is backed by fresh competitor and customer intelligence.',
            },
            {
              icon: Zap,
            ...
            },
            {
              ...
              desc:
                'Insights delivered directly into your existing tools: Slack alerts, dashboard updates, automated reports.',
            },
          ].map((benefit, i) => (
            <div
              key={i}

...
export default function MarketingWorkflowSection() {
  return (
    <section className="bg-gradient-to-b from-gray-50 via-white to-gray-50 py-20 px-6 lg:py-28">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-xl lg:text-2xl text-gray-600 max-w-5xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/95 backdrop-blur rounded-3xl shadow-2xl p-10 border border-gray-100">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl p-12 lg:p-16 text-white mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                desc: "No missed approvals, forgotten follow-ups, or data entry mistakes",
              },
              {
                icon: MessageSquare,
        ...
        <div className="mb-20">
          <h3 className="text-3xl lg:text-4xl font-bold text-center text-gray-900 mb-12">
            Why Choose <span className="text-indigo-600">SEO India Tech</span>{" "}
            for Workflow Solutions?
          </h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                desc: "PPC, SEO, content, and email — all perfectly coordinated",
              },
              {
                icon: BarChart3,
              ...
              >
                <benefit.icon className="w-12 h-12 text-indigo-600 mb-5" />
        ...
        {/* Final CTA */}
        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 rounded-3xl p-12 lg:p-16 text-center text-white shadow-2xl">

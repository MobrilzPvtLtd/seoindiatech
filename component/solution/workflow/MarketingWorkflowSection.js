...
export default function MarketingWorkflowSection() {
  return (
    <section className="bg-gradient-to-b from-gray-50 via-white to-gray-50 dark:from-background dark:via-gray-800 dark:to-gray-900 py-20 px-6 lg:py-28">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-xl lg:text-2xl text-muted dark:text-gray-100 max-w-5xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-primary to-secondary rounded-3xl blur-3xl opacity-30"></div>
            <div className="relative bg-white/95 dark:bg-card backdrop-blur rounded-3xl shadow-2xl p-10 border border-border">
        ...
        <div className="bg-secondary rounded-3xl p-12 lg:p-16 text-white mb-20">
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <benefit.icon className="w-12 h-12 text-primary mb-5" />
        ...
        {/* Final CTA */}
        <div className="bg-gradient-to-r from-primary to-primary-hover rounded-3xl p-12 lg:p-16 text-center text-white shadow-2xl">
          ...
          {/* <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <a
              href="#get-started"
              className="inline-flex items-center px-10 py-5 bg-white text-primary font-bold text-lg rounded-full hover:bg-cream transition shadow-xl hover:shadow-2xl"
            >
            ...
            <a
              ...
              className="inline-flex items-center px-10 py-5 bg-transparent border-3 border-white text-white font-bold text-lg rounded-full hover:bg-white hover:text-primary transition"
            >

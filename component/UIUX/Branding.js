...
const Branding = () => {
  return (
    <section className="bg-background dark:bg-background py-16 md:py-24 px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 opacity-20">
          <Sparkles className="w-24 h-24 text-accent dark:text-primary" />
        </div>

        <div className="absolute top-1/2 left-1/4 -translate-x-1/2 -translate-y-1/2 w-64 h-64 rounded-full bg-accent/20 dark:bg-accent/5 blur-3xl"></div>
        <div className="absolute top-1/4 right-1/4 translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full bg-accent/15 dark:bg-blue-300/5 blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col items-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 dark:bg-primary/15 backdrop-blur-sm text-primary dark:text-accent rounded-full text-sm font-medium mb-8">
          ...
          <div className="mt-8 px-4">
            <p className="text-muted dark:text-white/90 text-lg md:text-xl max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-10">
            <Link href="/services/digital-branding">
              <button className="cursor-pointer bg-primary dark:bg-card text-white px-8 py-4 rounded-full text-base font-semibold hover:bg-primary-hover dark:hover:bg-gray-700 transition-all shadow-lg hover:shadow-xl flex items-center group">
                Get Started
          ...
          <div className="hidden mt-16">
            <p className="text-muted dark:text-accent/90 text-sm font-medium uppercase tracking-wider mb-6 text-center">

...
const serviceItems = [
  {
    ...
    description: "Get found by the people who matter most—your potential customers.",
  ...
  },
  {
    ...
    description: "From eye-catching visuals to engaging videos, we tailor content to your audience's preferences.",
    icon: <Film className="w-5 h-5 text-blue-600 dark:text-blue-400" />
  },
  {
    title: "Analytics & Optimization",
    description: "We measure performance and continuously refine your content for maximum impact.",
    ...
    <section className="bg-white dark:bg-gray-900 py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center mb-16 relative z-10">
        ...
        <p className="max-w-2xl mx-auto text-gray-700 dark:text-gray-300 text-lg">
          Strategic content that builds authority, engages your audience, and drives measurable business results.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start relative z-10">
        ...
        <div className="space-y-6">
          <div>
            <p className="text-sm text-blue-700 dark:text-blue-400 font-semibold mb-2">What We Offer</p>
          ...
          <div className="relative rounded-xl overflow-hidden shadow-lg h-[300px] md:h-[400px] group">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-6">
              <p className="text-white font-medium">Targeting the right audience with precision</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mt-8">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
              <p className="text-3xl font-bold text-blue-700 dark:text-blue-400">67%</p>
              <p className="text-gray-700 dark:text-gray-300 text-sm">of B2B buyers rely on content to make purchasing decisions</p>
            </div>
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
              <p className="text-3xl font-bold text-blue-700 dark:text-blue-400">6x</p>
              <p className="text-gray-700 dark:text-gray-300 text-sm">higher conversion rates for companies using content marketing</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-8 space-y-8 shadow-[0_8px_0px_0px_rgba(59,130,246,0.5)] dark:shadow-[0_8px_0px_0px_rgba(59,130,246,0.3)] transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
          <div className="mb-8">
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Our Content Services</h3>
            <p className="text-gray-600 dark:text-gray-400">Comprehensive solutions designed to elevate your brand's voice and visibility</p>
          </div>
      ...
      <div className="max-w-7xl mx-auto mt-24 relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-4">Our Content Creation Process</h2>
          <p className="text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">A strategic approach that ensures your content delivers measurable results</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            { step: "1", title: "Research", desc: "Audience & competitor analysis" },
            { step: "2", title: "Strategy", desc: "Content planning & calendar" },
            { step: "3", title: "Creation", desc: "Writing, design & production" },
            { step: "4", title: "Optimization", desc: "Analytics & performance" }
          ].map((item, index) => (
            <div key={index} className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 text-center relative">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mt-3 mb-2">{item.title}</h3>
